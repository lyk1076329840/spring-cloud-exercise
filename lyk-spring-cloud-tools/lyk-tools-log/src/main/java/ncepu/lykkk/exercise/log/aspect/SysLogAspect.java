package ncepu.lykkk.exercise.log.aspect;
...
import ncepu.lykkk.exercise.log.event.SysLogEvent;
import ncepu.lykkk.exercise.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(ncepu.lykkk.exercise.log.annotation.SysLog)")
