package ncepu.lykkk.exercise.database.mybatis.conditions.query;
...
import ncepu.lykkk.exercise.base.entity.SuperEntity;
import ncepu.lykkk.exercise.database.mybatis.typehandler.BaseLikeTypeHandler;
import ncepu.lykkk.exercise.utils.StrPool;
...
public class LbqWrapper<T> extends AbstractLambdaWrapper<T, LbqWrapper<T>>
    ...
    /**
     * 忽略实体中的某些字段，实体中的字段默认是会除了null以外的全部进行等值匹配再次可以进行忽略
     * @param column
     * @param val
     * @return
     */
