package ncepu.lykkk.exercise.database.datasource;

import com.baomidou.mybatisplus.core.handlers.MetaObjectHandler;
import com.baomidou.mybatisplus.core.parser.ISqlParser;
import com.baomidou.mybatisplus.extension.parsers.BlockAttackSqlParser;
import com.baomidou.mybatisplus.extension.plugins.PaginationInterceptor;
import ncepu.lykkk.exercise.base.id.IdGenerate;
import ncepu.lykkk.exercise.base.id.SnowflakeIdGenerate;
import ncepu.lykkk.exercise.database.mybatis.typehandler.FullLikeTypeHandler;
import ncepu.lykkk.exercise.database.mybatis.typehandler.LeftLikeTypeHandler;
import ncepu.lykkk.exercise.database.mybatis.typehandler.RightLikeTypeHandler;
import ncepu.lykkk.exercise.database.parsers.TenantWebMvcConfigurer;
import ncepu.lykkk.exercise.database.properties.DatabaseProperties;
